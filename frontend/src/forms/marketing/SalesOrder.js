...
import TableRowsSalesOrder from "./TableRowsSalesOrder";
...
import { createSalesOrder,getSalesOrderNumber } from '../../services/SalesOrderServices';
...
function SalesOrder() {
    ...
    const [inputs, setInputs] = useState({'is_tax_included':true,'transport_mode':'own'});
   ...
   const [productCategories, setProductCategories] = React.useState([]);
    ...
    const handleQuotationFiltering = (companyId, siteId) => {
...
const constructFormData = () => {
    ...
    const dataArray = new FormData();
        ...
        //   dataArray.append("id",salesOrderFormData.id); 
          ...
          dataArray.append("quotation_id",inputs.quotation_no || EMPTY_STRING);
    ...
    Swal.fire({title: 'Do you want to save?',  
      ...
      cancelButtonText: `No`,
        ...
        { 
          ...
          createSalesOrder(cookies, constructFormData())
    ...
    <>
     <div id="outer-container"  className="App" > 
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data"> 
          <div id="header">
              <h3 className = "text font-weight-bold page-title" >SALES ORDER </h3>
          </div>
          <FloatingControls tableLink="/SalesOrderTable" onCancel={Cancel} enableCancel={true}/>
            ...
            <div className="container"> 
                ...
                <label htmlFor="company_id" className="form-group col-sm-4 text-right">Company</label>
                        ...
                        <select id="company_id"name="company_id" className="form-control col-sm-7 numsetting browser-default custom-select  mandatory-form-control"  required onChange={handleChange} value={inputs.company_id || ""}>
                ...
                <h5 className='col-sm-11'><b>Customer Details</b></h5><br/><br/>
                        ...
                        <select  id="customer_id" name="customer_id" className="form-control col-sm-7 browser-default custom-select mandatory-form-control" required onChange={handleChangeCustomerDetails} value={inputs.customer_id || ""}>
                        ...
                        <select  id="consignee_id" name="consignee_id" className="form-control col-sm-7 browser-default custom-select mandatory-form-control" required onChange={handleChangeSiteDetails } value={inputs.consignee_id || ""}>
                ...
                <div className="form-row table-bordered shadow p-2 my-2 border-secondary p-2 mb-3 bg-blue form-control-panel" >
                    <h5 className='col-sm-11'><b>Quotation Details</b></h5><br/><br/>
                        ...
                        <select  id="quotation_no" name="quotation_no" className="form-control col-sm-7 browser-default custom-select " onChange={handleChangeQuotationDetails } value={inputs.quotation_no || ""}>
            ...
            <div className="form-row table-bordered shadow p-2 my-2 border-secondary p-2 mb-3 bg-blue container table-responsive  form-control-panel">
                ...
                <table className="table order-list"  id="order_list"
                // style={{textAlign:"center",borderRadius:"10px",border:"3px solid black",backgroundColor:" RGB(188,232,253)"}}
                >
                    <thead>
                        <tr>
            ...
            <div className="form-row table-bordered shadow p-2 my-2 border-secondary p-2 mb-3 bg-blue form-control-panel" >
                {/* <label htmlFor="product_amount" className="form-group col-sm-2 text-right">Total Product Value </label>
                <input type="text" className="form-control col-sm-2 number1" name="product_amount" value={inputs.product_amount || 0}  readOnly={true} style={{textAlign:"right", cursor: "not-allowed"}} id="product_amount" disabled/> */}
